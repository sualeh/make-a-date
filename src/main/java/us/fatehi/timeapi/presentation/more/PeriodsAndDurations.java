 ...
 * >JSR 310: A New Java Date/Time API</a> Durations: A duration represents a
 * length of elapsed time, defined to the nanosecond level; for example,
 * "100,000 nanoseconds" is a duration. Durations are somewhat similar to
 * periods, which also define a length of elapsed time; however, unlike periods,
 * durations represent a precise number of elapsed nanoseconds. Periods: Like
 * durations, periods represent a length of elapsed time. Examples of periods
 * are "4 years, 8 days," and "1 hour." As shown by these examples, periods are
 * defined using calendar fields (years, days, hours, etc.), rather than by an
 * exact number of nanoseconds.
 *
...
public class PeriodsAndDurations {
	...
	public void acrossDSTBoundary() {
		...
		final ZonedDateTime mar8 = ZonedDateTime.of(LocalDate.of(2014, Month.MARCH, 8), LocalTime.of(23, 30),
