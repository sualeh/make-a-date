...
public class HumanTimeDemo
{
  ...
  public static void main(final String[] args)
  {
     ...
     * between ZonedDateTime and OffsetDateTime in my time zone. For
     * each class, I obtained an instance that reflected 3 a.m. on
     * November 2, 2013 and November 3, 2013. (DST ends in my time zone
     * at 2 a.m. on November 3.)
     */

    zonedDateTime = ZonedDateTime
      .of(2013, 11, 2, 3, 00, 0, 0, ZoneId.of("America/Chicago"));
    System.out.printf("Zoned date and time = %s%n", zonedDateTime);

    zonedDateTime = ZonedDateTime
      .of(2013, 11, 3, 3, 00, 0, 0, ZoneId.of("America/Chicago"));
    System.out.printf("Zoned date and time = %s%n", zonedDateTime);

    /*
     * However, OffsetDateTime will not change the offset because it has
     * no access to time zone rules, so it's unable to find out when DST
     * ends.
     */
