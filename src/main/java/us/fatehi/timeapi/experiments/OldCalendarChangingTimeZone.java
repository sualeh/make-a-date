...
public class OldCalendarChangingTimeZone {
	...
	private static final DateFormat format = SimpleDateFormat.getDateTimeInstance(DateFormat.LONG, DateFormat.LONG,
	...
	public static void main(final String[] args) {
		...
		print(date);
		System.out.println(String.format("DEBUG fields: %d-%d-%d %d:%d TZ %d", date.get(YEAR), date.get(MONTH),
				date.get(DATE), date.get(HOUR), date.get(MINUTE), date.getTimeZone().getRawOffset()));
